          ...
          <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 md:gap-x-28 md:gap-y-28">
            ...
            >
              ...
              <p className="text-medium">
                Beginnen Sie Ihre weiterbildung in wenigen tagen
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                <Button title="Weiter" variant="secondary">
                  Weiter
                </Button>
                <Button
                  title="Weiter"
            ...
            >
              ...
              <p className="text-medium">
                Wählen Sie einen Kurs, der zu Ihren Zielen passt. Durchsuchen
                Sie unser Angebot in Projektmanagement, Online Marketing oder KI
                und Digitalisierung.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                <Button title="Weiter" variant="secondary">
            ...
            >
              ...
              <p className="text-medium">
                Ihr Gutschein wird genehmigt und Sie erhalten Zugang zu allen
                Materialien. Beginnen Sie sofort mit dem Lernen in Ihrem eigenen
                Tempo.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                <Button title="Weiter" variant="secondary">
