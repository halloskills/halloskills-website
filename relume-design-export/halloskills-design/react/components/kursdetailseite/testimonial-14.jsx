        ...
        <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <h5 className="text-h5 font-bold">
              "Der Kurs hat mir nicht nur neue Fähigkeiten gegeben, sondern auch
              das Selbstvertrauen, mich auf neue Positionen zu bewerben. Die
              Betreuung war ausgezeichnet."
            </h5>
            <div className="mt-6 flex flex-nowrap items-center gap-5 md:mt-8">
              <div>
                <p className="font-semibold">Sarah Müller</p>
                <p>Projektmanagerin, Berlin</p>
              </div>
