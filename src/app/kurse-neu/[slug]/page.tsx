...
import { KURSE_NEU, findeKursNeu } from "@/lib/kurse-neu-data";
...
export async function generateStaticParams() {
  return KURSE_NEU.map((k) => ({ slug: k.slug }));
}
...
/**
 * Lehrgangs-Detailseiten im Design System v1.0 — parallel zu den
 * bestehenden Seiten unter /kurse/[slug] (altes Design, andere Lehrgänge).
 * Noch nicht offiziell verlinkt oder indexiert (siehe generateMetadata).
 */
export default async function KursDetailNeu({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
