      ...
      <div className="mx-auto max-w-[1200px] px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {team.map((person, i) => (
            ...
            >
              <div className="mb-5 overflow-hidden rounded-full" style={{ width: 100, height: 100 }}>
                <img
                  src={person.img}
                  alt={person.name}
